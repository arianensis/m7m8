...
// Get a list of chat groups loaded from the database and converts them to a recycler view
public class RecyclerGroupAdapter extends RecyclerView.Adapter<RecyclerGroupAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // for each group, create a click listener that will open the corresponding chat
