...
// The same as RecyclerGroupAdapter but for private chats (it will also display if the user is online)
public class RecyclerUserAdapter extends RecyclerView.Adapter<RecyclerUserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int i) {
        ...
        // for each user, create the corresponding entry with the name
        holder.recUsername.setText(arrayList.get(i).getUsername());

        // load the green circle if the user is online, red otherwise
        ...
        // create click listener to open the corresponding chat
